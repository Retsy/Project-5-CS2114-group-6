...
public class GUIGraphWindow implements Observer 
{
    ...
    public void legend()
    {
        ...
        Shape blackBox = new Shape(x - 300, y - 300, 300, 300, Color.BLACK);
        Shape whiteBox = new Shape(x - 295, y - 295, 295, 295, Color.WHITE);
        ...
        TextShape read = new TextShape(0, 0, "Read", Color.PINK);
        TextShape art = new TextShape(x - width, y - height, "Art", Color.BLUE);
        TextShape sports = new TextShape(x - width, y - height, "Sport", Color.YELLOW);
        TextShape music = new TextShape(x - width, y - height, "Music", Color.GREEN);
        TextShape song = new TextShape(x - width, y - height, "SongTitle", Color.BLACK);
        TextShape heard = new TextShape(x - width, y - height, "Heard", Color.BLACK);
        TextShape likes = new TextShape(x - width, y - height, "Likes", Color.BLACK);
